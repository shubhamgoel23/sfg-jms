package com.spring.sfgjms.sender;
...
public class HelloSender {
	...
	// pre configured jms template for activemq server much like jdbc template
		...
		Message receviedMsg = jmsTemplate.sendAndReceive(JmsConfig.MY_SEND_RCV_QUEUE, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				try {
					...
					helloMessage.setStringProperty("_type", "com.spring.sfgjms.model.HelloWorldMessage");
